                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item active">
                                    {{-- {{ __('Login') }} --}}
                                <a class="nav-link mx-2" style="color: rgba(0,64,109)" href="{{ route('login') }}"><strong>{{ __('Login') }}</strong></a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                        {{-- {{ __('Register') }} --}}
                                    <a class="nav-link mx-2"  style="color: rgba(0,64,109)" href="{{ route('register') }}"><strong>{{ __('Register') }}</strong></a>
                                </li>
                            @endif
                        @else
                                <li class="nav-item">
                                <a id="navbarDropdown" class="nav-link mx-2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
